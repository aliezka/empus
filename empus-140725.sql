...
-- Dumping data for table empus.komentar_desc: ~5 rows (approximately)
...
-- Dumping data for table empus.notification: ~0 rows (approximately)
...
-- Dumping data for table empus.notification_history: ~0 rows (approximately)
...
-- Dumping data for table empus.notification_involved: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `notification_opini` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `notification_id` int(11) NOT NULL,
  `opini_id` int(11) NOT NULL,
  PRIMARY KEY (`notification_id`,`opini_id`),
  UNIQUE KEY `id` (`id`),
  KEY `opini_id` (`opini_id`),
  CONSTRAINT `notification_opini_ibfk_1` FOREIGN KEY (`notification_id`) REFERENCES `notification` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `notification_opini_ibfk_2` FOREIGN KEY (`opini_id`) REFERENCES `opini` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table empus.notification_opini: ~0 rows (approximately)
/*!40000 ALTER TABLE `notification_opini` DISABLE KEYS */;
/*!40000 ALTER TABLE `notification_opini` ENABLE KEYS */;
...
-- Dumping data for table empus.person: ~9 rows (approximately)
...
-- Dumping data for table empus.user: ~3 rows (approximately)
...
INSERT INTO `user` (`id`, `username`, `password`, `email`, `person_id`, `remember_token`, `created_at`, `updated_at`) VALUES
	...
	(30, 'kelurahan@te.st', '$2y$10$2YngJs6q62QoEa9XVPVczemEF1rAERv86dirdPTpS9ktsPlfPHf5.', 'kelurahan@te.st', 43, 'rLneR2YNrlpKfsZoS6dLN4vZKPUvzLatAGyOZCR0vbJm7ixIwwUd77OyOQiy', '2014-07-13 15:17:52', '2014-07-13 15:19:05'),
	(31, 'user@te.st', '$2y$10$XqmNB0gQWeIT.eqg8NgPHux3XTK9vFS/6VnCat8oHCv7dhT3gXCwK', 'user@te.st', 44, 'HpsIVsAMoB5gQpHB2qLBWKLXmqfiUXVOKkvwmp5VQzRM73A1BbdGTbE81y1k', '2014-07-13 15:18:15', '2014-07-14 01:03:52');
...
-- Dumping data for table empus.user_role: ~5 rows (approximately)
