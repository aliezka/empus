...
INSERT INTO `instansi` (`id`, `name`, `person_id`, `ts_created`) VALUES
	(11, 'Kelurahan Tegal Gundil', 36, '2014-07-11 23:31:41');
...
-- Dumping data for table empus.komentar_desc: ~2 rows (approximately)
...
-- Dumping data for table empus.opini: ~1 rows (approximately)
...
-- Dumping data for table empus.opini_desc: ~1 rows (approximately)
...
-- Dumping data for table empus.person: ~2 rows (approximately)
...
INSERT INTO `prosedur` (`id`, `order`, `title`, `pelayanan_id`, `ts_created`) VALUES
	(4, 1, 'Pemohon membuat surat pengantar dari kelurahan dengan membawa surat pengantar dari RT dan persyaratan yang di tentukan.', 4, '2014-07-11 23:44:14'),
...
-- Dumping data for table empus.prosedur_desc: ~2 rows (approximately)
...
-- Dumping data for table empus.user: ~2 rows (approximately)
/*!40000 ALTER TABLE `user` DISABLE KEYS */;
INSERT INTO `user` (`id`, `username`, `password`, `email`, `person_id`, `remember_token`, `created_at`, `updated_at`) VALUES
	(23, 'admin@a.a', '$2y$10$0m/I.eKvDY2ylUHtN8CaIuemXv5Y7D4VqZwiXLp2S.TnZct2pouHS', 'admin@a.a', 36, NULL, '2014-07-11 15:54:00', '2014-07-12 07:16:40'),
	(24, 'tg@a.a', '$2y$10$AgDg69JxqY1JDSLNy0LxSeHGV8hpBJzopmk6WYwqI72WbQrLGzXJm', 'tg@a.a', 37, 'Hts7y40uGuUtkqqQ7L4kvIpxzYuPAm4IFlddN9YU5WiMhYfZFeonbvnmF8Uk', '2014-07-12 08:40:12', '2014-07-12 09:33:24');
...
-- Dumping data for table empus.user_role: ~4 rows (approximately)
