                        ...
                        <li>
                            <div class="row">
                                <div class="small-3 columns">
                                    <img src="{{!is_null($User->person->img) ? asset('assets/img/person/'.$User->person->img->img) : Config::get('empus.instansi_thumb_img')}}" alt="" height="75" height="75">
                                </div>
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="{{ URL::to('opini', $Opini->opini->id)}}">
                                <div class="row">
                                    <div class="small-3 columns">
                                        <img src="{{checkImageThumb(!is_null($Opini->opini->person->img) ? $Opini->opini->person->img->img : null,'person')}}" width="75">
                                    </div>
                                    <div class="small-9 columns">
                                        <div class="info">
